...
import { ProductPriceAgentCard } from '../components/ProductPriceAgentCard';
import { ProductPriceAgentListSkeleton } from '../skeleton/ProductPriceAgentSkeleton';
import { EmptyState } from '../../../components/shared/EmptyState';
import { ProductPriceAgentProduct } from '../types/productpriceagent.types';

export function ProductPriceAgentListScreen() {
    ...
    return (
        <View className="flex-1 bg-gray-50">
            <HeaderNavigator title="PRODUCT PRICE AGENT" />
                ...
                {isInitializing ? (
                    ...
                    <Animated.View entering={FadeIn.delay(300)} className="items-center justify-center mt-16">
                        ...
                        <Text className="text-sm text-gray-500 text-center px-10">
                            Pilih produk dari dropdown di atas untuk melihat informasi harga agent.
                        </Text>
                    </Animated.View>
                ) : isDetailLoading ? (
                    ...
                    <Animated.View entering={FadeInDown.duration(400)}>
                        <TouchableOpacity
                            activeOpacity={0.8}
                            onPress={() => navigation.navigate('ProductPriceAgentDetailScreen', { id_product: selectedProduct?.id_product })}
                        >
                    ...
                    <EmptyState
                        ...
                        message="Tidak ada data harga agent untuk produk yang dipilih."
                        fullScreen={false}
                    />
                )}
            </ScrollView>
