...
export function ProductEditScreen() {
    ...
    const {
        ...
        updateField, addOption, removeOption, updateOption, loadInitialData, save, validateForm
    } = useProductForm(id);
    ...
    }, [id, route.params?.showSuccessToast]);
                                ...
                                <View className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 mb-6" pointerEvents={isEditing ? 'auto' : 'none'}>
                                    ...
                                    <View className="mb-2">
                                        <View className="flex-row items-center justify-between mb-4">
                                            <Text className="text-sm font-bold text-gray-700">Options</Text>
                                            {isEditing && (
                                                <TouchableOpacity
                                                    onPress={addOption}
                                        ...
                                        {formData.options.length === 0 && (
                                            <View className="py-4 items-center border border-dashed border-gray-300 rounded-xl bg-gray-50">
                                                <Text className="text-gray-400 text-xs font-medium">Belum ada option yang ditambahkan.</Text>
                                            </View>
                                        )}
                                    </View>
