...
interface PoOptionTableProps {
    options: PoOptionItem[];
    onToggleOption?: (index: number) => void;
    onPriceChange?: (index: number, price: number) => void;
    isReadOnly?: boolean;
}

export function PoOptionTable({ options, onToggleOption, onPriceChange, isReadOnly = false }: PoOptionTableProps) {
    return (
