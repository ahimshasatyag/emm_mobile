...
function CustomDrawerContent(props: DrawerContentComponentProps) {
    ...
    const getActiveSubMenu = (route: string) => {
        ...
        if (route === 'EmployeePosisiList') return 'Position';
                    ...
                    return (
                        <CustomExpandableMenu
                            ...
                            onSubMenuPress={(subMenuName) => {
                                ...
                                } else if (subMenuName === 'Position') {
                                    props.navigation.navigate('EmployeePosisiList');
...
export function SideBarNavigator() {
    return (
        ...
        >
            ...
            <Drawer.Screen name="EmployeePosisiList" component={require('../../features/employeeposisi/screens/EmployeePosisiScreen').EmployeePosisiScreen} />
