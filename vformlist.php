                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="float-right">
                            <a href="#" onclick="show('<?=$folder;?>/cform/','#main'); return false;"
                                class="btn btn-info btn-sm pull-right"><i class="fas fa-list"></i> </a>

                            <a href="#" onclick="show('<?=$folder;?>/cform/view2/','#main'); return false;"
                                class="btn btn-info btn-sm pull-right"><i class="fas fa-th-large"></i> </a>
